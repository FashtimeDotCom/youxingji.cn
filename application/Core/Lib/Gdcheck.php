...
//		$this->GetNumber();
	...
	function getNumber(){
		...
		$row = Core_Db::fetchOne("Select * From " . self::$Table . " Where id = '" . $this->ckID . "'");
	...
	function updatesession(){
		...
		Core_Db::update(self::$Table, "id = '" . $this->ckID . "'", $ar);
	...
	function createImg(){
		...
		&& function_exists('imagefilledrectangle') && function_exists('imagerectangle')){
			...
			$code->width = $this->Img_x;
			
			$code->height = $this->Img_y;
