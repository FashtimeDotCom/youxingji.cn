...
class Core_Util_Tutil
{
	...
	public static function utf82gb($utfstr)
    {
        ...
        {
            return Core_Fun::iconv('utf-8','gbk//ignore',$utfstr);
        }
	...
	{
		$akeywords = Core_Config::get('akeywords', 'basic', '');
