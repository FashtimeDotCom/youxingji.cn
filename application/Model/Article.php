 ...
 * 文章模型
 */
class Model_Article extends Core_Model
{
	/**
     * Database table name.
     * @var (string)
     ...
     */
    protected $_fields = array('id', 'catid', 'catarr', 'moduleid', 'brandid', 'classid', 'title', 'titlecolor', 'content', 'cutstr', 'articlepic', 'articlethumb', 'attachlist', 'tagword', 'seotitle', 'keywords', 'description', 'sort', 'istop', 'isspecial', 'isindex', 'useable', 'uid', 'realname', 'comefrom', 'addtime', 'updatetime', 'shownum', 'feednum', 'bestnum', 'stownum', 'fileurl', 'isview',"label_id");
	...
	public function deleteByIds($ids)
	{
		...
		else
		{
			...
			foreach($ids AS $id)
	        {
	        	...
	        	C::M('module')->mtable($moduleid)->removeall("aid = '$id'");
	        	...
	        	if($galleries)
	        	{
	        		foreach($galleries AS $gallery)
		        	{
		        		...
		        		C::M('gallery')->remove ($gallery['id']);
		        	}
	        	}

	        	Core_Fun_File::delete(BASEROOT . $articlepic);
				Core_Fun_File::delete(BASEROOT . $articlethumb);
