 ...
 * 消息模型
 */
class Model_User_Message extends Core_Model
{
	/**
	 * 表名
	 * 
	...
	{
		$_friendModel = new Model_User_Friend();
		...
		{
			$messages[$idx]['fs'] = $_friendModel->getFriendStatus(array(array('fid', $message['fromuid']), array('uid', $message['touid'])));
		}
		return $messages;
	}
