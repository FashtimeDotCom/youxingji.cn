 ...
 * Time: 17:29
 */
class Controller_Index_Swimdetail extends Core_Controller_TAction
{
    ...
    public function detailAction()
    {
        ...
        $info['desccibes']=Core_fun::cn_substr(strip_tags($user_info['autograph']),190,'...');
