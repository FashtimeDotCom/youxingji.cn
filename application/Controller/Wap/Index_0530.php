        ...
        foreach ($scenery as $key => $value) { 
      	...
      	$t = array(
        	'y' => date('Y'),
          	...
          	'd' => date('d'),
          	'list' => array(
            	0 => date('d', strtotime('-1 sunday', time())),
              	1 => date("d",mktime(0, 0 , 0,date("m"),date("d")-date("w")+1,date("Y"))),
              	2 => date("d",mktime(0, 0 , 0,date("m"),date("d")-date("w")+2,date("Y"))),
              	3 => date("d",mktime(0, 0 , 0,date("m"),date("d")-date("w")+3,date("Y"))),
              	4 => date("d",mktime(0, 0 , 0,date("m"),date("d")-date("w")+4,date("Y"))),
              	5 => date("d",mktime(0, 0 , 0,date("m"),date("d")-date("w")+5,date("Y"))),
              	6 => date("d",mktime(0, 0 , 0,date("m"),date("d")-date("w")+6,date("Y"))),
            )
        );
