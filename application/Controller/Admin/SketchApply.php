 ...
 * Time: 15:40
 */
class Controller_Admin_SketchApply extends Core_Controller_Action
{
    var $_pagetitle="写生报名";
    ...
    public function indexAction()
    {
        ...
        $type_model=new Model_SketchApply();
        $perpage=15;
        $mapurl="admin/sketchApply/index/";
        ...
        $this->display("admin/sketch/sketch_apply.tpl");
    }
