...
(function($){
	...
	$.jWindowCrop = function(image, options){
		...
		base.init = function(){
			...
			$('.arrow-in').on('click.'+base.namespace, base.zoomIn);
			$('.arrow-out').on('click.'+base.namespace, base.zoomOut);
			...
			$('#picmodel').on('mousedown.'+base.namespace+' touchstart.'+base.namespace, handleMouseDown);
