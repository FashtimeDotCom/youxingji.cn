                    ...
                    <div class="m-txt-lb">
                        <table>
                            <tr><td width="90px"><span>称号：</span></td>
                                <td><input type="text" class="inp" id="username" value="{{$user.username}}"></td>
                            </tr>
                            ...
                            <tr><td><span>居住城市：</span></td>
                                <td><input type="text" class="inp" id="city" value="{{$user.city}}"></td>
                            </tr>
                            <tr><td><span>出生日期：</span></td>
                                <td><input type="text" class="inp" id="birthday" value="{{$user.birthday}}"></td>
                            </tr>
                            <tr><td><span>个人简介：</span></td>
                                <td><textarea class="area" id="autograph">{{$user.autograph}}</textarea></td>
                            </tr>
                            <tr><td></td>
