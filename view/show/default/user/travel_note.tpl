			...
			<div class="m-con-lb1">
				<div class="col-l">
					<div class="m-edit-lb">
						...
						<div class="tit">
							<textarea class="layui-textarea" id="LAY_demo1" style="display: none" placeholder="请发表你的游记">{{$res.content}}</textarea>
						</div>
						<div class="tit">
							<input type="text" class="inp" value="{{$res.describe}}" id="describe" placeholder="请在这里输入封面描述">
						</div>
						<div class="layui-upload">
							...
							<div class="layui-upload-list" id="piclist">
								{{if $res.pic != ''}}
								<div class="upic"><img src="{{$res.pic}}" class="layui-upload-img"></div>
								{{else}}
