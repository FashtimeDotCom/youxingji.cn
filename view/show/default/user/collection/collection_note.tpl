						...
						<div class="commonality">
							<ul class="ul_box">
								...
								<li class="item_{{$vo.t_id}}">
									...
									<div class="con fix">
										<div class="left">
											<a class="dis_block figure borderRadius50 headPortrait" style="background-image: url({{$vo.headpic}});" href="/index.php?m=index&c=index&v=star_detail&id={{$vo.uid}}"></a>
											<a class="title" href="/index.php?m=index&c=index&v=star_detail&id={{$vo.uid}}">{{$vo.username}}</a>
										</div>
										<div class="right txt">
											<div class="title">
												<div class="IMGbox fix">
									...
									<div class="bottom">
										...
										<div class="zan" onclick="zan(this,{{$vo.id}})" data-sign="my" data-nature="list" data-val="note_num">
											<a href="javascript:;"><em class="smallIcon"></em><i class="Iclass">{{$vo.top_num}}</i></a>
										</div>
										<div class="look"><em class="smallIcon"></em><i class="Iclass">{{$vo.show_num}}</i></div>
									</div>
									{{/if}}
								</li>
								{{/foreach}}
