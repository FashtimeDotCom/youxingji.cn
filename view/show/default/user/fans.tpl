...
<body>
                    ...
                    <div class="m-atten-lb">
                        <div class="tit">
                            <div class="so">
                                ...
                                <input type="text" class="inp" id="keys" value="{{$keys}}" placeholder="查找朋友">
                            </div>
                            <h4>我的粉丝 <em>{{$user.uid|helper:'fansnum'}}</em></h4>
                        </div>
                    </div>
                    <ul class="ul-list-lb2">
                        ...
                        <li>
                            <div class="items">
                                ...
                                <div class="txt">
                                    <h4><a href="{{$vo.uid|helper:'href'}}">{{$vo.username}}</a></h4>
                                    <div class="con">
    ...
    <script type="text/javascript">
        $('#pageqr').click(function(){
            var page = $('#pages').val();
            if(page){
                window.location.href="/index.php?m=index&c=user&v=fans&keys={{$key}}&page=" + page;
            }
        })
