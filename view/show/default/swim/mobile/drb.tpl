	...
	{{if $info}}
		...
		<div class="item">
			...
			<div class="d-nav">
				...
				<div data-url = "{{if $item.id==1}}/index.php?m=wap&c=swim&v=roster_list&activity_id=4{{else}}{{if $item.living}}/index.php?m=wap&c=swim&v=roster_list&activity_id={{$item.living.activity_id}}{{else}}javascript:void(0){{/if}}{{/if}}">
