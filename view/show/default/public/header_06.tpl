    <div class="header">
        <div class="wp">
            <div class="logo"><a href="/"><img src="/resource/images/logo.png" alt=""></a></div>
            <ul class="nav">
                <li {{if $ns == ''}}class="on"{{/if}}><a href="/">首页</a></li>
                <li {{if $ns == 'journey'}}class="on"{{/if}}><a href="/index.php?m=index&c=index&v=journey">甄选之旅</a></li>
            ...
            <div class="hdr">
                ...
                <div class="user">
                    ...
                    <dl>
                        ...
                        <dd><a href="/index.php?m=index&c=user&v=logout">退出</a></dd>
                    </dl>
                </div>
                {{if $weidu > 0}}
                <div class="tx">
