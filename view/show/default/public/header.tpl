...
<div class="header">
    <div class="wp">
        ...
        <ul class="nav">
            ...
            <!--<li {{if $ns == ''}}class="on"{{/if}}><a href="/index.php?m=index&c=index&v=new_index">首页</a></li>-->
            <li {{if $ns == 'swim'}}class="on"{{/if}}><a href="/index.php?m=index&c=swim&v=index">免费游</a></li>
            <li {{if $ns == 'new_star'}}class="on"{{/if}}><a href="/index.php?m=index&c=index&v=new_star">达人邦</a></li>
            <li {{if $ns == 'star'}}class="on"{{/if}}><a href="/index.php?m=index&c=travel&v=travel_list">达人日志</a></li>
            <li {{if $ns == 'tv'}}class="on"{{/if}}><a href="/index.php?m=index&c=index&v=tv">达人视频</a></li>
            <li {{if $ns == 'ryt'}}class="on"{{/if}}><a href="/index.php?m=index&c=travelnote&v=note_list">达人游记</a></li>
            <li {{if $ns == 'faq'}}class="on"{{/if}}><a href="/index.php?m=index&c=faq&v=index">达人问答</a></li>
            <!--<li {{if $ns == 'daren'}}class="on"{{/if}}><a href="javascript:;">如何达人</a></li>-->
            <li {{if $ns == 'new_list'}}class="on"{{/if}}><a href="/index.php?m=index&c=article&v=new_list">独家旅行</a></li>
        </ul>
        <div class="hdr">
        	<div class="left">
            	<div class="search">
