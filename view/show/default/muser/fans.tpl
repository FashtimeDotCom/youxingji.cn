...
<head>
    ...
    <title>TA的粉丝_{{TO->cfg key="site_name" group="site" default="致茂网络"}}</title>
...
<body>
                ...
                <div class="col-r">
                    <div class="m-atten-lb">
                        <div class="tit">
                            ...
                            <h4>TA的粉丝 <em>{{$muser.uid|helper:'fansnum'}}</em></h4>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        $('#pageqr').click(function(){
            var page = $('#pages').val();
            if(page){
                window.location.href="/index.php?m=index&c=muser&v=fans&id={{$muser.uid}}&keys={{$key}}&page=" + page;
            }
        })
        ...
        $('#btnSo').click(function(){
            ...
            window.location.href="/index.php?m=index&c=muser&v=fans&id={{$muser.uid}}&keys=" + keys;
        })
