...
<body>
    ...
    <div class="main">
        ...
        <div class="row-sz pb30">
            <div class="m-nv-sz">
                <div class="wp">
                    <ul>
                        <li><a href="/index.php?m=index&c=muser&v=index&id={{$muser.uid}}">TA的旅行日志</a></li>
                        <li class="on"><a href="/index.php?m=index&c=muser&v=album&id={{$muser.uid}}">TA的相册</a></li>
    ...
    <script>
        ...
        $('#pageqr').click(function(){
            var page = $('#pages').val();
            if(page){
                window.location.href="/index.php?m=index&c=muser&v=album&id={{$muser.uid}}&page=" + page;
            }
        })
    </script>
    <!-- 弹窗 -->
