...
<head>
    ...
    <title>TA的关注_{{TO->cfg key="site_name" group="site" default="致茂网络"}}</title>
...
<body>
                ...
                <div class="col-r">
                    <div class="m-atten-lb">
                        <div class="tit">
                            ...
                            <h4>TA的关注 <em>{{$muser.uid|helper:'follownum'}}</em></h4>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        $('#pageqr').click(function(){
            var page = $('#pages').val();
            if(page){
                window.location.href="/index.php?m=index&c=muser&v=follow&id={{$muser.uid}}&keys={{$key}}&page=" + page;
            }
        })
        ...
        $('#btnSo').click(function(){
            ...
            window.location.href="/index.php?m=index&c=muser&v=follow&id={{$muser.uid}}&keys=" + keys;
        })
