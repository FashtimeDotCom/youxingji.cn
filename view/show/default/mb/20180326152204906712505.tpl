...
<body>
    ...
    <div class="main">
        <div class="ban s4" style="background-image: url(/resource/images/ban1-1-hlg.jpg);"></div>
        <div class="m-inner-lb1">
            <div class="wp">
                <h4 class="m-tit-lb1">“丝绸之路”旅游接力赛路线</h4>
                <div class="map">
                    <img src="/resource/images/map-lb1.png" alt="">
                </div>
            </div>
        </div>
            ...
            <div class="wp">
                ...
                <ul class="ul-txt-lb1">
                    <li>
                        <div class="items">
                            <h4>丝绸之路 </h4>
                            <p>达人种子招募令是游行迹根据国家“丝绸之路”和“精准扶贫”战略，推出的“丝绸之路”沿线65个国家免费体验之旅。</p>
                        </div>
                    </li>
                    <li>
                        <div class="items">
                            <h4>精准扶贫 </h4>
                            <p>根据“精准扶贫”战略，每一个“丝绸之路”国家旅游点，游行迹都为贫困学生提供免费旅游基金，开阔贫困学生的视野，让其更加深入地了解“丝绸之路”</p>
                        </div>
                    </li>
                    <li>
                        <div class="items">
        ...
        <div class="m-inner-lb3">
            <div class="wp">
                <h4 class="m-tit-lb1">“丝绸之路”达人种子招募令第一棒——柬埔寨</h4>
                <div class="con1">
                ...
                <ul class="ul-img-lb1">
                    <li>
                        <div class="img">
                            <img src="/resource/images/img-lb3.jpg" alt="">
                        </div>
                    </li>
                    <li>
                        <div class="img">
                ...
                <div class="con2">
                    ...
                    <p>作为中国商务部首批中标的境外经贸合作区之一，你应该去游览“丝绸之路”重要港口——<em>西哈努克港</em></p>
                ...
                <div class="con3">
                    ...
                    <div class="item">
                        <p><em>阶段一：</em>达人种子报名 （2018年2月4日~2月14日）</p>
                        <p><em>阶段二：</em>达人种子选拔 （2018年2月14日~2月21日）</p>
                        <p><em>阶段三：</em>公布名单 （2018年2月24日）</p>
                        <p><em>阶段四：</em>达人种子直播 （2018年3月7日~3月15日）</p>
                    </div>
                    <div class="item">
                        <h4>获选旅行达人种子（共1名）将赢得</h4>
                        <p>
                            <span>1. 5000元/人旅行基金</span>
                            <span>2. 境外人身旅游意外保险 </span>
                            <span>3. 游行迹达人种子”称号</span>
                            <span>4. “游行迹达人种子”荣誉证书</span>
                            <span>5. 游行迹文化衫2件</span>
                        </p>
                    </div>
                    <a href="/index.php?m=index&c=index&v=entered" class="apply">我要报名</a>
                </div>
            </div>
        </div>
        ...
        <div class="m-inner-lb4" style="background-image: url(/resource/images/bg-lb4.png);">
            <div class="wp">
                <h4 class="m-tit-lb1">关于“丝绸之路”旅行接力赛，你应该了解这些</h4>
                <div class="con">
                    <h4>你能获得什么收获</h4>
                    <p>1. 免费获得与当地消费相符的旅行基金、境外人身旅游意外保险。</p>
                    <p>2. 还可收获“游行迹达人种子”称号，晋升达人邦，荣获游行迹荣誉证书。</p>
                    <p>3. 深入了解“丝绸之路”国家的风俗文化，体验当地的风土人情。</p>
                ...
                <div class="con">
                    ...
                    <p>人生，至少该有一次跳出现有的生活圈，做一次张扬的人生主角，“丝绸之路”旅行的故事等你来书写，给旅行一个新的定义，寻找一个全新的自己！</p>
                </div>
            </div>
        </div>
        <div class="m-inner-lb5" style="background-image: url(/resource/images/bg-lb5.jpg);">
            <div class="wp">
                <h4 class="m-tit-lb1">“丝绸之路”达人种子招募令Q&A</h4>
                <div class="con">
                    <h4>每一站的旅行目的地均包含哪些奖品？</h4>
                    <p>游行迹将为达人种子提供“旅行基金＋境外旅游险”。旅行基金需要达人种子合理规划使用。旅行基金中已将签证费用、往返机票、酒店住宿、餐饮费用等预算在其中签证和往返机票由游行迹代为办理，达人种子可在游行迹规定的出发范围内自行选择入驻酒店。达人种子需合理评估行程费用，旅行总支出超出旅行基金的部分，需达人种子自行承担，比如由于自身原因误机造成的损失。</p>
                </div>
                <div class="con">
                    <h4>旅行的签证由谁办理？</h4>
                ...
                <div class="con">
                    <h4>获选后后如何领取旅行基金？</h4>
                    <p>游行迹将在每一期活动获选名单公布后的24小时内，联系最终获得旅行机会的达人种子签订《“丝绸之路”达人种子协议》。达人种子需在48小时内签订协议并回复扫描件。获选达人种子需准备好个人护照信息。若因达人种子个人原因无法联系、未能在指定时间内签订协议或无法在规定时间内完成出票，将自动视为放弃奖项。</p>
                </div>
                <div class="con">
                    <h4>旅行基金什么时候派发？</h4>
                ...
                <div class="con">
                    ...
                    <p>达人种子需与游行迹签署《“丝绸之路”达人种子协议》，若达人种子因为自身因素放弃出行，将视为放弃奖励，不予补发、折现和任何形式的发放；若达人种子因为自身因素未完成行程或中途退出，需承担补偿（详见《“丝绸之路”达人种子协议》）。</p>
                </div>
                <div class="con">
                    <h4>旅行过程中是否能自由规划旅行路线？</h4>
                    <p>每一个“丝绸之路”沿线国家的旅游均为自由行，除了游行迹指定必去的景点需游览外，路线可由达人种子自行规划。</p>
                </div>
                <div class="con">
