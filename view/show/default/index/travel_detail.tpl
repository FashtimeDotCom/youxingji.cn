						...
						<div class="user-in">
							<div class="user-head">
								<div class="Head_portrait">
									<a href="index.php?m=index&c=muser&v=index&id={{$info.uid}}"><img src="{{$info.headpic}}"></a>
								</div>
								<div class="user-info-box">
									...
									<div class="user-text user_text">{{$info.describes}}</div>
								</div>
							</div>
							<ul class="row">
								{{if $info.content}}
								{{foreach from=$info.content key=key item=item}}
								<li><a class="lightbox" href="{{$item}}" rel="list{{$id}}"><img src="{{$item}}"></a></li>
								{{/foreach}}
								{{/if}}
							</ul>
							<div class="clear"></div>
			...
			<div class="col-r">
				<div class="r_box">
					...
					<ul class="r_box_con">
						...
						<li><div class="user_head">
								<div class="Head_portrait">
									<a href="index.php?m=index&c=muser&v=index&id={{$info.uid}}" target="_blank"><img src="{{$item.headpic}}"></a>
								</div>
							...
							<div class="pic"><img src="{{$item.content}}"/></div>
						</li>
						{{/foreach}}
						{{/if}}
					</ul>
				...
				<div class="r_box">
					...
					<ul class="r_box_con">
						...
						<li><a href="/index.php?m=index&c=index&v=star&keyword={{$vo.keyword}}">
								<div class="pic">
									<img src="{{$vo.pics}}" alt="">
									<span>{{$vo.title}}</span>
								</div>
