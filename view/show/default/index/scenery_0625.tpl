...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/resource/css/main1400.css"  media="screen and (min-width: 1300px) and (max-width: 1500px)">
                    ...
                    <a href="javascript:;" class="js-pop1">
                        ...
                        <div class="txt">
                            ...
                            <div class="num">
								...
								<div class="spot ">{{$vo.topnum}}1212</div>
								<div class="Read ">{{$vo.shownum}}3333</div>
							</div>
							-->
                        </div>
                    </a>
