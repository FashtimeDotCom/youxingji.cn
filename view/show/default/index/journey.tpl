...
<head>
    ...
    <title>{{$journey.seotitle}}_甄选之旅_{{TO->cfg key="site_name" group="site" default="广州游行迹新媒体科技有限公司"}}</title>
...
<body>
    ...
    <div class="main">
        <div class=""><img style="width: 100%;" src="{{$journey.articlepic}}"/></div>
        <div class="cur">
            <div class="wp">
            ...
            <div class="box-prod">
                ...
                <div class="col-r">
                    <div class="m-txt1">
                        <h4>{{$journey.title}}</h4>
                        <div class="info">
                            <div class="price">￥{{$journey.extend.price}}元/位
