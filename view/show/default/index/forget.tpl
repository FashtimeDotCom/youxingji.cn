    ...
    <div class="main">
        <div class="m-login-lb" style="background-image: url(/resource/images/bg-lb1.jpg);">
            <div class="m-login-con">
                <h4 class="tit"><a href="/index.php?m=index&c=index&v=login">想起密码？马上登录</a>找回密码</h4>
                <div class="item">
                ...
                <div class="item">
                    <input type="password" class="inp" id="password" placeholder="新密码">
                </div>
                <p class="y-set"></p>
                <input type="submit" class="sub sub2" id="btnRegUser" value="立即找回">
            </div>
        </div>
    </div>
    <div class="footer">
        <div class="fd-bot">
            <div class="wp">
                ...
                <div class="addr">
                    ...
                    <p>{{TO->cfg key="site_powerby" group="site" default=""}} {{TO->cfg key="site_beian" group="site" default=""}}</p>
