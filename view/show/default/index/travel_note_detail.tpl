	                ...
	                <div class="m-text1-qm">
	                    ...
	                    <div class="info">
	                        ...
	                        <div class="g-operation-qm">
	                            <span class="look"><i></i>{{$article.show_num}}</span>|
	                            <a href="javascript:;" onclick="zan(this,{{$article.id}})" data-nature="subject" data-discern="2">
	                            	<em></em><i class="Iclass">{{$article.top_num}}</i>
	                            </a>
	                        </div>
	                    </div>
