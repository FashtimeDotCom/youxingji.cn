        ...
        <div class="row-a1" style="padding-bottom: 15px;">
            <div class="wp">
                ...
                <div class="m-pic1">
                    <ul id="demo">
                        <li class="active">
                            <a href="http://www.youxingji.cn/index.php?m=index&c=index&v=recruiting&id=1" target="_blank"><img src="/resource/images/shou4.jpg"  /></a>
                            <div><a href="javascript:void(0)"></a></div>
                        </li>
                        <li>
                            <a href="http://www.youxingji.cn/index.php?m=index&c=swim&v=index" target="_blank"><img src="/resource/images/shou2.jpg"  /></a>
                            <div><a href="javascript:void(0)"></a></div>
                        </li>
                        <li>
                            <a href="http://www.youxingji.cn/index.php?m=index&c=swim&v=index" target="_blank"><img src="/resource/images/shou3.jpg"  /></a>
                            <div><a href="javascript:void(0)"></a></div>
                        </li>
