...
<body class="index">
    ...
    <div class="mian" style="margin-top: 0px;">
        ...
        <ul class="ul-imgtxt1">
            <li>
                <a href="/">
		            <i style="background-image: url(/resource/m/images/q-icon13.png);"></i>
		            <span>首页</span>
		        </a>
            </li>
            <li>
        ...
        <div class="index-row3">
            ...
            <div class="pic"><a href="{{$adlist.linkurl}}"><img src="{{$adlist.imgurl}}" alt="" /></a></div>
            {{/vplist}}
        </div>
                            ...
                            <table cellspacing="0">
                                ...
                                <tbody id="idCalendar">
                                  	<tr>
                                    	...
                                    	<td isclick="0" id="{{$v}}" {{if $v == $t.d}}class="onToday"{{/if}}>{{$v}}</td>
                                      	{{/foreach}}
                                 	</tr>
                                </tbody>
                            </table>
        ...
        function getryt(time,t) {
            $.ajax({
                ...
                success: function(data){
                    if(data['id']){
                        $('#getryt').html('<h5 onclick=href("'+'/index.php?m=wap&c=index&v=rytdetai&id='+data['id']+'")>'+data['title']+'</h5><div onclick=href("'+'/index.php?m=wap&c=index&v=rytdetai&id='+data['id']+'")>'+data['homecontent']+'</div>');
                    }else{
                        $('#getryt').html("无内容");
                    }
                }
