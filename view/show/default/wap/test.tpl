...
<html>
	...
	<body>
		<div class="wxapi_container">
			...
			<div class="lbox_close wxapi_form">
				...
				<h3 id="user">获取微信服务器接口</h3>
				<span class="desc">获取用户上传图片</span>
				<button class="btn btn_primary" id="userimg">userimg</button>
	...
	<script type="text/javascript">
		...
		wx.ready(function() {
			...
			//提交到我们服务器
			document.querySelector('#userimg').onclick = function() {
				var host = window.location.host;
				var src = "//" + host + '/' + 'index.php?m=api&c=upload&v=wechat_upload';
				var data = {
					list: images.serverId
				}
				console.log(images.serverId.length)
				$.ajax({
					url: src,
					data: data,
					type: "POST",
