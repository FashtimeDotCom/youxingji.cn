				...
				<div class="wp">
					<form>
						...
						<div class="tit" style="margin-bottom: 20px;">
							<textarea class="layui-textarea inp txta1" id="describe" placeholder="请在这里输入游记的摘要/封面描述" style="line-height: 22px;">{{$res.desc}}</textarea>
						...
						<div class="pic-video tit">
							<div class="myfile fix">
								<div class="layui-upload-list fix" id="piclist" style="height: 100%;">
									{{if $res.thumbfile != ''}}
									<img class="note_bg layui-upload-img" data-default="" src="{{$res.thumbfile}}">
									{{else}}
