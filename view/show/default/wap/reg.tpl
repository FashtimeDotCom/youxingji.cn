...
<head>
    ...
    <title>注册_{{TO->cfg key="site_name" group="site" default="致茂网络"}}</title>
...
<body class="">
    <div class="mian">
        <div class="m-login" style="background-image: url(/resource/m/images/bg-register.jpg);">
            <div class="box">
                <div class="con">
                    <div class="logo">
                    ...
                    <input type="password" placeholder="账户密码" id="pass1" class="inp" />
                    <p class="y-set p4"></p>
                    <input type="submit" value="立即注册" id="btnRegUser" class="btn btn1" />
                    <p class="p3">注册视为同意<a href="/article/yszc">《游行迹用户使用协议》</a></p>
                    <div class="choose">
                        <p class="p1">你还可以选择第三方直接登录</p>
                        <a href="" class="link1" style="background-image: url(/resource/m/images/sina.png);"></a>
                        <a href="" class="link1" style="background-image: url(/resource/m/images/qq.png);"></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="verificationcode">
        <img id="gdField" src="" gd="{{$_pathroot}}{{$_gdurl}}" onclick="reloadgd(this, true)"/> 
