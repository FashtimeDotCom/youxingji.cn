    ...
    <table class="mtb" id="general-table">
        ...
        <tr>
        	<td colspan="2" class="td27">
            	<a href="javascript:void(0);" class="btn active">封面（缩图168*120）</a>
            </td>
        </tr>
        <tr class="noborder">
        ...
        <tr class="noborder">
            <td class="vtop">
                <div id="uploader-single">
                    <!--用来存放item-->
                    <img width="" height="" src="{{$article.top_pic}}" id="imagess" style="max-width: 120px" />
                </div>
                <input type="hidden" id="images" name="top_pic" value="{{$article.top_pic}}">
