...
<form name="cpform" method="post" action="/admin/recruiting/edit" id="cpform" enctype="multipart/form-data">
    <table class="mtb" id="general-table">
        <tr><td colspan="2" class="td27">招募名称</td></tr>
        <tr class="noborder">
        	<td class="vtop rowform">
            <input name="title" value="{{$article.title}}" type="text" class="txt" datatype="Require" msg="请填写招募名称" />
            </td>
        ...
        <tr class="noborder">
        	<td class="vtop rowform">
            <input name="url" value="{{$article.url}}" type="text" class="txt" datatype="Require" msg="请填写报名网址" />
            </td>
        ...
        <tr class="noborder">
            <td class="vtop">
                <div id="uploader-single">
                    <!--用来存放item-->
                    <img width="" height="" src="{{$article.banner}}" id="imagess" style="max-width: 120px" />
                </div>
                <input type="hidden" id="images" name="banner" value="{{$article.banner}}">
                <a id="banner">选择图片</a>
            </td>
        ...
        <tr class="noborder">
            <td class="vtop">
                ...
                <input type="hidden" id="pc_mb" name="pc_mb" value="{{$article.pc_mb}}">
                <a id="dwed">选择模板</a>
            </td>
            <script type="text/javascript">
                var singleuploaders = WebUploader.create({
        ...
        <tr class="noborder">
            <td class="vtop">
                ...
                <input type="hidden" id="wap_mb" name="wap_mb" value="{{$article.wap_mb}}">
                <a id="wapdwed">选择模板</a>
            </td>
            <script type="text/javascript">
                var singleuploaders = WebUploader.create({
