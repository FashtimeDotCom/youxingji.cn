    ...
    <div class="row">
        <div class="col-md-12">
            <div class="block-flat">
                <form class="form-horizontal group-border-dashed" action="{{$_pathroot}}admin/link/save"
                    ...
                    <div class="content">
                        ...
                        <div class="form-group">
                            <label class="control-label input_label">伙伴名称</label>
                            <div class="">
                                <input type="text" class="form-control input_box"  name="name" value="{{$detail.name}}" placeholder="伙伴名称" parsley-trigger="change">
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="control-label input_label">链接</label>
                            <div class="">
                                <input type="text" class="form-control input_box"  name="link" value="{{$detail.link}}" placeholder="链接" parsley-trigger="change">
                            </div>
                        </div>
                            ...
                            <div class="" style="margin-left: 200px;">
                                <div id="uploader-single">
                                    ...
                                    <div id="fileList" class="uploader-list" style="display: inline-block">
                                        {{if $detail.linkpic}}
                                        <img width="120" src="{{$detail.linkpic}}" />
                                        {{/if}}
                                    </div>
                                ...
                                <input type="hidden" id="imgurl" name="pics" value="{{$detail.linkpic}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <select name="status" id="status">
                                    ...
                                    <option value="{{$key}}" {{if $detail.useable==$key}}selected{{/if}}>{{$item}}</option>
                                    {{/foreach}}
                                    {{/if}}
                                </select>
                            </div>
    ...
    $(function () {
        ...
        $("#save").click(function(){
            if( beforeSubmit() ){
                ...
                $.post("{{$_pathroot}}admin/link/save", $('#form').serialize(), function(data) {
                    if(!data.error){
