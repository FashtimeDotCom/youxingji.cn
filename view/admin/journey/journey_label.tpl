...
<form method="post" action="/admin/JourneyLabel/morescenery" name="lpform" id="lpform">
    <table class="tb tb2" id="sTable">
        ...
        <tr class="hover">
            ...
            <td class="tdl">
                <a href="javascript:;" onclick="Controller.main('{{$_pathroot}}admin/JourneyLabel/edit/id/{{$vo.id}}')" >编辑</a>
            </td>
        </tr>
        {{/foreach}}
        <tr>
            ...
            <td class="tdl" colspan="2">
                <button class="btn btn-success" type="submit" onclick="Controller.update('admin/JourneyLabel/', 'morescenery')">修改</button>
                <button class="btn btn-danger" type="submit" onclick="Controller.delete('admin/JourneyLabel/', 'deletescenery')">删除</button>
            </td>
