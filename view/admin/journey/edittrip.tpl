...
<form name="cpform" method="post" action="/admin/article/edittrip" id="cpform" enctype="multipart/form-data">
    <table class="mtb" id="general-table">
        ...
        <tr class="noborder">
            <td class="vtop rowform">
            <input name="sort" value="{{$article.sort}}" type="text" class="txt" datatype="Require" msg="请填写排序" />
            </td>
        ...
        <tr class="noborder">
            <td class="vtop rowform">
            <input name="days" value="{{$article.days}}" type="text" class="txt" datatype="Require" msg="请填写第几天" />
            </td>
        ...
        <tr class="noborder">
        	<td class="vtop rowform">
            <input name="title" value="{{$article.title}}" type="text" class="txt" datatype="Require" msg="请填写行程" />
            </td>
        ...
        <tr class="noborder">
            <td class="vtop rowform">
            <textarea name="pictitle" style="width: 350px">{{$article.graphic}}</textarea>
            </td>
        ...
        <tr class="noborder">
            <td class="vtop" colspan="2">
                {{$swfupload}}
                {{include file='admin/uploads.tpl'}}
            </td>
        </tr>
    </table>
    <div class="btnfix">
