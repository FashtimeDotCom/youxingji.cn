    ...
    <div class="row">
        <div class="col-md-12">
            <div class="block-flat">
                <div class="content">
                    <form class="form-horizontal group-border-dashed" action="{{$_pathroot}}admin/starTravelEveryday/save"
                        ...
                        <div class="form-group">
                            <label class="control-label input_label">旅行标题</label>
                            <div class="">
    ...
    $(function () {
        ...
        $("#save").click(function(){
            if( beforeSubmit() ){
                ...
                $.post("{{$_pathroot}}admin/starTravelEveryday/save", $('#form').serialize(), function(data) {
                    if(!data.error){
