    ...
    <div class="row">
        <div class="col-md-12">
            <div class="block-flat">
                <div class="content">
                    <form class="form-horizontal group-border-dashed" action="{{$_pathroot}}admin/starTravel/save"
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <select name="user_id" id="user_id" class="user_id">
                                    ...
                                    <option value="{{$key}}" {{if $detail.user_id==$key}}selected{{/if}}>{{$item}}</option>
                                    {{/foreach}}
                                    {{/if}}
                                </select>
                            </div>
    ...
    $(function () {
        ...
        $("#save").click(function(){
            if( beforeSubmit() ){
                ...
                $.post("{{$_pathroot}}admin/starTravel/save", $('#form').serialize(), function(data) {
                    if(!data.error){
