...
<div class="floattop">
    <ul>
         ...
         <li class="btn btn-info" onclick="Controller.controller('添加作品','admin/youhua/addscenery')"><span>添加作品</span></li>
    </ul>
</div>
<form method="post" action="/admin/youhua/morescenery" name="lpform" id="lpform">
	<table class="tb tb2" id="sTable">
        ...
        <tr class="hover">
            ...
            <td class="tdl">
                <a href="javascript:;" onclick="Controller.controller('修改作品', 'admin/youhua/editscenery/id/{{$vo.id}}')" >编辑</a>
            </td>
        </tr>
        {{/foreach}}
        <tr>
            ...
            <td class="tdl" colspan="2">
                <button class="btn btn-success" type="submit" onclick="Controller.update('admin/youhua/', 'morescenery')">修改</button>
                <button class="btn btn-danger" type="submit" onclick="Controller.delete('admin/youhua/', 'deletescenery')">删除</button>
            </td>
