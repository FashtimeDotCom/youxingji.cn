...
<form name="cpform" method="post" action="/admin/youhua/editwriter" id="cpform" enctype="multipart/form-data">
    <table class="mtb" id="general-table">
        <tr><td colspan="2" class="td27">名称</td></tr>
        <tr class="noborder">
            <td class="vtop rowform">
            <input name="name" value="{{$article.name}}" type="text" class="txt" datatype="Require" msg="请填写名称" />
            </td>
        ...
        <tr class="noborder">
            <td class="vtop rowform">
            <textarea style="width:500px" name="introduction" type="text" class="txt" datatype="Require" msg="请填写简介">{{$article.introduction}}</textarea>
            </td>
