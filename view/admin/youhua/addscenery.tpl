...
<form name="cpform" method="post" action="/admin/youhua/addscenery" id="cpform" enctype="multipart/form-data">
    <table class="mtb" id="general-table">
        ...
        <tr class="noborder">
            <td class="vtop rowform">
                <input name="price" value="" type="number" class="txt" datatype="Require" msg="价格" />
            </td>
            <td class="vtop tips2">价格</td>
        </tr>
        <tr class="noborder">
            <td class="vtop rowform">
                <input name="show_num" value="" type="number" class="txt" datatype="Require" msg="查看数" />
            </td>
            <td class="vtop tips2">查看数</td>
        </tr>
        <tr class="noborder">
            <td class="vtop rowform">
                <input name="top_num" value="" type="number" class="txt" datatype="Require" msg="点赞数" />
            </td>
            <td class="vtop tips2">点赞数</td>
        </tr>
        <tr class="noborder">
            <td class="vtop rowform">
                <input name="from" value="" type="text" class="txt" datatype="Require" msg="来源" />
            </td>
