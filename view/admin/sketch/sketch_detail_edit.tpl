    ...
    <div class="row">
        <div class="col-md-12">
            <div class="block-flat">
                <div class="content">
                    <form class="form-horizontal group-border-dashed" action="{{$_pathroot}}admin/sketchDetail/save"
                          style="border-radius: 0px;" id="form" name="form" enctype="multipart/form-data" method="post">

                        <input type="hidden" id="id" name="id" value="{{$detail.id}}">

                        <div class="form-group">
                            <label class="control-label input_label">写生列表</label>
                            <div class="">
    ...
    $(function () {
        ...
        $("#save").click(function(){
            if( beforeSubmit() ){
                ...
                $.post("{{$_pathroot}}admin/sketchDetail/save", $('#form').serialize(), function(data) {
                    if(!data.error){
