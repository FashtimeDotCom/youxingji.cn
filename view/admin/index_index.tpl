...
<body>
    ...
    <div id="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="sub-menu open" index="{{$smarty.foreach.topmenu.index}}" data-search="{{$key}}">
                <a href="javascript:void(0);" class="pitem" onclick="change_menu({{$smarty.foreach.topmenu.index}})">
