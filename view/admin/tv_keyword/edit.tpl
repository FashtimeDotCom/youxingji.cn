...
<div class="middle_zone">
    ...
    <ol class="breadcrumb" style="display: inline-block;border: none;">
        ...
        <li><a href="javascript:void(0)">达人视频</a> / </li>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="block-flat">
                <div class="content">
                    <form class="form-horizontal group-border-dashed" action="{{$_pathroot}}admin/TvKeyword/save"
                        ...
                        <div class="form-group">
                            ...
                            <div class="" style="margin-left: 200px;">
                                ...
                                <a id="dwed">选择图片</a>
                                {{/if}}
                                <span style="color: red;">(280 * 185)</span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="">
                                <select name="status" id="status" class="type_id">
                                    {{if $status_list}}
                        ...
                        <div class="form-group">
                            <label class="control-label input_label">关键字</label>
                            <div class="">
                                <input type="text" class="form-control input_box"  name="keyword" value="{{$detail.keyword}}" placeholder="关键字" parsley-trigger="change">
                            </div>
                        </div>
    ...
    $(function () {
        ...
        $("#save").click(function(){
            if( beforeSubmit() ){
                ...
                $.post("{{$_pathroot}}admin/TvKeyword/save", $('#form').serialize(), function(data) {
                    if(!data.error){
