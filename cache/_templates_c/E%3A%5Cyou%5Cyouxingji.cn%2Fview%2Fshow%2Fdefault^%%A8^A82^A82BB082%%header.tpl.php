<?php /* vpcvcms compiled created on 2018-08-02 15:59:26
...
<div class="hd-r">
    ...
    <ul class="nav">
        ...
        <li><a href="/index.php?m=wap&c=index&v=ryt"><i style="background-image: url(/resource/m/images/q-icon7.png);"></i>日阅潭</a></li>
        <li><a href="/index.php?m=wap&c=index&v=mxp"><i style="background-image: url(/resource/m/images/q-icon8.png);"></i>玩转明信片</a></li>
        <li><a href="/index.php?m=wap&c=user&v=index"><i style="background-image: url(/resource/m/images/q-icon9.png);"></i>个人中心</a></li>
    </ul>
</div>