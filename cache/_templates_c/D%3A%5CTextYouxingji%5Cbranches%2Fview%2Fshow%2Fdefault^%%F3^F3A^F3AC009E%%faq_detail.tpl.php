<?php /* vpcvcms compiled created on 2019-01-04 11:07:48
	    ...
	    <div class="container fix">
			...
			<div class="hunk question fix">
				<div class="title fix">
					...
					<span class="name whiteSpace"><?php echo $this->_tpl_vars['faq_info']['title']; ?>
</span>
				</div>
				<div class="headPortrait fix">
					<?php if ($this->_tpl_vars['faq_info']['thumbfile']): ?>
					<a href="<?php echo $this->_tpl_vars['faq_info']['thumbfile']; ?>
" class="thumbnail lightbox figure" style="background-image: url(<?php echo $this->_tpl_vars['faq_info']['thumbfile']; ?>
);"></a>
					<?php endif; ?>
					<p class="description whiteSpace"><?php echo $this->_tpl_vars['faq_info']['desc']; ?>
</p>
				</div>
...
" />
	    	...
	    	<input type="hidden" name="" id="pageCount" data-id="<?php echo $this->_tpl_vars['faq_info']['id']; ?>
...
?>
					<div class="hunk fix">
						...
						<div class="substance fix">
							<div class="solution description whiteSpace"><?php echo $this->_tpl_vars['item']['content']; ?>
</div>
