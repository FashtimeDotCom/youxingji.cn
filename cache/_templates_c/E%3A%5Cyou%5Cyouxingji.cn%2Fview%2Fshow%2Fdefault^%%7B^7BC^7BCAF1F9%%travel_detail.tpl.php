<?php /* vpcvcms compiled created on 2018-11-05 14:58:57
...
"></a>
								...
								<div class="user-info-box">
									...
									<div class="user-text user_text"><?php echo $this->_tpl_vars['info']['describes']; ?>
</div>
								</div>
							</div>
							<ul class="row">
...
?>
								<li><a class="lightbox" href="<?php echo $this->_tpl_vars['item']; ?>
...
?>
						<li><div class="user_head">
								<div class="Head_portrait">
									<a href="index.php?m=index&c=muser&v=index&id=<?php echo $this->_tpl_vars['info']['uid']; ?>
" target="_blank"><img src="<?php echo $this->_tpl_vars['item']['headpic']; ?>
"></a>
								</div>
...
" target="_blank"><?php echo $this->_tpl_vars['item']['describes']; ?>
							...
							<div class="pic"><img src="<?php echo $this->_tpl_vars['item']['content']; ?>
"/></div>
						</li>
						<?php endforeach; endif; unset($_from); ?>
						<?php endif; ?>
				...
				<div class="r_box">
					<div class="r_box_title">热门旅游地</div>
					<ul class="r_box_con">
						<?php $_from = $this->_tpl_vars['tourismlist']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['vo']):
?>
						<li><a href="/index.php?m=index&c=index&v=star&keyword=<?php echo $this->_tpl_vars['vo']['keyword']; ?>
">
								<div class="pic">
