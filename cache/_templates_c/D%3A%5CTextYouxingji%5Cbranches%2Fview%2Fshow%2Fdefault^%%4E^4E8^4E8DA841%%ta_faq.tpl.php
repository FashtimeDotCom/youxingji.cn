<?php /* vpcvcms compiled created on 2018-12-29 21:50:09
         compiled from wap/muser/ta_faq.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'helper', 'wap/muser/ta_faq.tpl', 64, false),)), $this); ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8" />
	...
	<div class="mian">
	    ...
	    <div class="ban figure fix">
	        ...
	        <div class="message fix">
	        	<a class="dis_block gaine figure" href="/index.php?m=wap&c=user&v=index" style="background-image: url(<?php echo $this->_tpl_vars['muser']['avatar']; ?>
);"></a>
	        	<div class="rightBox<?php if ($this->_tpl_vars['muser']['tag']): ?><?php else: ?> MarginBottom<?php endif; ?>">
	        		<div class="wx_name fix">
	        			<span class="username"><?php echo $this->_tpl_vars['muser']['username']; ?>
</span>
...
,this)"><?php echo ((is_array($_tmp=$this->_tpl_vars['muser']['uid'])) ? $this->_run_mod_handler('helper', true, $_tmp, 'isfollows') : smarty_modifier_helper($_tmp, 'isfollows')); ?>
	    ...
	    <!--正文-->
	    <input type="hidden" name="uid" id="uid" data-type="4" value="<?php echo $this->_tpl_vars['muser']['uid']; ?>
" />
...
">游记&nbsp;<i class="Iclass" id="note_num"><?php echo $this->_tpl_vars['total']['note_num']; ?>
	                    ...
	                    <li class="on"><a href="/index.php?m=wap&c=muser&v=ta_faq&id=<?php echo $this->_tpl_vars['muser']['uid']; ?>
