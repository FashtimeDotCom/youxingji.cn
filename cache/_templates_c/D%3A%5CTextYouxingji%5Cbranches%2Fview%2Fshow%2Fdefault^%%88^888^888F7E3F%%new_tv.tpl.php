<?php /* vpcvcms compiled created on 2019-01-02 16:17:48
         compiled from wap/new_tv.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'helper', 'wap/new_tv.tpl', 131, false),)), $this); ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8" />
		            ...
		            <div class="wp row_list">
		                <ul class="ul-list-talent ul-imgtxt2">
		                    <li><div class="item fix">
			                        <a class="dis_block con cover figure" href="/index.php?m=wap&c=index&v=tv_detail&id=<?php echo $this->_tpl_vars['vo']['id']; ?>
...
" style="background-image: url(<?php echo ((is_array($_tmp=$this->_tpl_vars['vo']['uid'])) ? $this->_run_mod_handler('helper', true, $_tmp, 'avatar') : smarty_modifier_helper($_tmp, 'avatar')); ?>
			                        ...
			                        <div class="info character"><div class="txt"><p><a class="dis_block omit lineNumber3 whiteSpace" href="/index.php?m=wap&c=index&v=tv_detail&id=<?php echo $this->_tpl_vars['vo']['id']; ?>
