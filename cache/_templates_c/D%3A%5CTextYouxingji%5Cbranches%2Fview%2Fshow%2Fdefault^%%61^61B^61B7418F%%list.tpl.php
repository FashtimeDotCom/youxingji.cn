<?php /* vpcvcms compiled created on 2019-01-10 15:12:33
         compiled from index/about_us/list.tpl */ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8" />
    ...
    <title>关于我们_<?php echo $this->_reg_objects['TO'][0]->cfg(array('key' => 'site_name','group' => 'site','default' => "广州游行迹新媒体科技有限公司"), $this);?>
</title>
...
unset($_smarty_tpl_vars);
 ?> 
    <div class="main">
        <?php $_from = C::T('ad')->getList(array('tagname' => 'pc_aboutus_list'));if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
?>
				<div class="module fix">
					<a class="dis_block fix" href="/index.php?m=index&c=aboutus&v=detail&id=<?php echo $this->_tpl_vars['item']['id']; ?>
">
						<div class="linellae top"></div>
						<div class="linellae bottom"></div>
						<p class="articleTitle"><em></em><span class="titleName"><?php echo $this->_tpl_vars['item']['title']; ?>
</span></p>
						<p class="time"><?php echo $this->_tpl_vars['item']['addtime']; ?>
</p>
						<div class="figure borderRadius cover" style="background-image: url(<?php echo $this->_tpl_vars['item']['thumbfile']; ?>
);">
							<p class="describe omit"><?php echo $this->_tpl_vars['item']['describes']; ?>
</p>
						</div>
					</a>
				</div>
