<?php /* vpcvcms compiled created on 2018-09-28 19:30:24
         compiled from wap/faq/faq_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'helper', 'wap/faq/faq_list.tpl', 220, false),)), $this); ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8" />
...
" title="海报">
	    ...
	    <div class="container fix" data-index="1">
	    	<!--热门问答  列表-->
	    	<input type="hidden" name="" id="modulesNum1" title="旅游达人的总数" value="<?php echo $this->_tpl_vars['total']; ?>
" />
...
" title="问的对应的图片"/></div>
							...
							<div class="bottom fix">
								<div class="left fix">
									<span class="boxes">答&nbsp;<img class="profilePhoto" src="<?php echo $this->_tpl_vars['item']['avatar']; ?>
"/></span>&nbsp;
									<span class="name"><?php echo $this->_tpl_vars['item']['username']; ?>
</span>&nbsp;<span class="time">2018-01-28</span>
								</div>
								<div class="right fix">
...
?>
							...
							<div class="swiper-slide">
								<div class="pic fix"><img class="profilePhoto" src="<?php echo $this->_tpl_vars['item']['headpic']; ?>
" alt="" title="头像"></div>
...
" />
	    	...
	    	<!--待回答问题  列表-->
	    	<input type="hidden" name="" id="modulesNum3" title="旅游达人的总数" value="<?php echo $this->_tpl_vars['total']['star']; ?>
" />
