<?php /* vpcvcms compiled created on 2018-11-02 16:56:55
...
"><img src="/resource/m/images/icon_right.png"/></a>
	                ...
	                <div class="txt" style="margin-top: 8px;"><p class="intro"><?php echo $this->_tpl_vars['tjstar']['0']['autograph']; ?>
</p></div>
...
,this)"><?php echo ((is_array($_tmp=$this->_tpl_vars['vo']['uid'])) ? $this->_run_mod_handler('helper', true, $_tmp, 'isfollows') : smarty_modifier_helper($_tmp, 'isfollows')); ?>
		                            ...
		                            <div class="txt">
		                            	<p><a class="dis_block" href="/index.php?m=wap&c=index&v=star_detail&id=<?php echo $this->_tpl_vars['vo']['id']; ?>
