<?php /* vpcvcms compiled created on 2019-01-09 16:14:58
         compiled from user/findfriends.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'helper', 'user/findfriends.tpl', 67, false),)), $this); ?>
<!DOCTYPE html>
<html lang="zh-CN">
...
" placeholder="查找朋友">
                            ...
                            <h4>查找好友 <em><?php echo $this->_tpl_vars['num']; ?>
个</em></h4>
                        </div>
                    </div>
 ...
 ?>
    ...
    <script type="text/javascript">
        $('#pageqr').click(function(){
            var page = $('#pages').val();
            if(page){
                window.location.href="/index.php?m=index&c=user&v=findfriends&keys=<?php echo $this->_tpl_vars['key']; ?>
&page=" + page;
            }
        })
        ...
        $('#btnSo').click(function(){
            ...
            window.location.href="/index.php?m=index&c=user&v=findfriends&keys=" + keys;
        })
