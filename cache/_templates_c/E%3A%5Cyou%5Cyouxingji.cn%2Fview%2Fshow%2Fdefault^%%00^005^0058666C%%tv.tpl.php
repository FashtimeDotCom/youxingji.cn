<?php /* vpcvcms compiled created on 2018-07-31 14:51:43
...
<head>
    ...
    <title>TA的旅拍TV_<?php echo $this->_reg_objects['TO'][0]->cfg(array('key' => 'site_name','group' => 'site','default' => "致茂网络"), $this);?>
</title>
 ...
 ?>
    ...
    <script>
        ...
        $('#pageqr').click(function(){
            var page = $('#pages').val();
            if(page){
                window.location.href="/index.php?m=index&c=muser&v=tv&id=<?php echo $this->_tpl_vars['muser']['uid']; ?>
&page=" + page;
            }
        })
    </script>
