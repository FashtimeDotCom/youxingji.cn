<?php /* vpcvcms compiled created on 2018-09-12 16:07:30
         compiled from user/follow.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'helper', 'user/follow.tpl', 59, false),)), $this); ?>
<!DOCTYPE html>
<html lang="zh-CN">
...
" id="keys" placeholder="查找朋友">
                            ...
                            <h4>我的关注 <em><?php echo ((is_array($_tmp=$this->_tpl_vars['user']['uid'])) ? $this->_run_mod_handler('helper', true, $_tmp, 'follownum') : smarty_modifier_helper($_tmp, 'follownum')); ?>
</em></h4>
                        </div>
                    </div>
 ...
 ?>
    ...
    <script type="text/javascript">
        $('#pageqr').click(function(){
            var page = $('#pages').val();
            if(page){
                window.location.href="/index.php?m=index&c=user&v=follow&keys=<?php echo $this->_tpl_vars['key']; ?>
&page=" + page;
            }
        })
        ...
        $('#btnSo').click(function(){
            ...
            window.location.href="/index.php?m=index&c=user&v=follow&keys=" + keys;
        })
