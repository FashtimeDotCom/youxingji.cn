<?php /* vpcvcms compiled created on 2018-07-12 09:45:37
						...
						<div class="user-info">
							<div class="user-head">
								<div class="Head_portrait">
									<img src="<?php echo $this->_tpl_vars['item']['info']['headpic']; ?>
"/> <!--暂时写死-->
								</div>
								<div class="user_name">
									<h1>种子选手</h1><!--暂时写死-->
							...
							<div class="user-text">
								<?php echo $this->_tpl_vars['item']['info']['describes']; ?>
...
?>
									<li><a><img src="http://www.youxingji.cn<?php echo $this->_tpl_vars['val']; ?>
"/></a></li>
...
<?php else: ?>javascript:void(0)<?php endif; ?>" class="live" id="live" value="更多直播" style="background-image: url('/resource/images/swim/icon_xm.png');" /><!--渲染三级页面后改-->
					</div>
