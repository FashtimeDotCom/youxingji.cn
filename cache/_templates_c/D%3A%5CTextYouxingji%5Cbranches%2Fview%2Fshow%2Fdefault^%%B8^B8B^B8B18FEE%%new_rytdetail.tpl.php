<?php /* vpcvcms compiled created on 2018-12-29 15:42:06
         compiled from index/new_rytdetail.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'helper', 'index/new_rytdetail.tpl', 132, false),array('modifier', 'date_format', 'index/new_rytdetail.tpl', 181, false),)), $this); ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
...
?>
	    <div class="ban s2" style="background-image: url(<?php echo $this->_tpl_vars['article']['top_pic']; ?>
);"></div>
	                ...
	                <div class="m-text1-qm">
	                    ...
	                    <div class="info">
	                        ...
	                        <div class="g-operation-qm">
	                            <span class="look"><i></i><?php echo $this->_tpl_vars['article']['shownum']; ?>
</span>|
	                            <a href="javascript:;" onclick="zan(this,<?php echo $this->_tpl_vars['article']['id']; ?>
)" data-nature="subject" data-discern="1">
	                            	<em></em><i class="Iclass"><?php echo $this->_tpl_vars['article']['zannum']; ?>
</i>
	                            </a>
	                        </div>
	                    </div>
