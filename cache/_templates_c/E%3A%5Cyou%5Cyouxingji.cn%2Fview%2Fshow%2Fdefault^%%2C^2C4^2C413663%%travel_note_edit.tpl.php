<?php /* vpcvcms compiled created on 2018-07-25 17:42:39
         compiled from user/travel_note_edit.tpl */ ?>
<!DOCTYPE html>
<html lang="zh-CN">
			...
			<div class="wp">
				...
				<div class="m-con-lb1">
					<div class="col-l">
						<div class="m-edit-lb">
							<div class="tit">
								<input type="text" class="inp" value="<?php echo $this->_tpl_vars['info']['title']; ?>
" id="title" placeholder="请在这里输入标题">
							</div>
							<div class="tit">
								<textarea class="layui-textarea" id="LAY_demo1" style="display: none" placeholder="请发表你的游记"><?php echo $this->_tpl_vars['info']['content']; ?>
</textarea>
							</div>
							<div class="tit">
								<input type="text" class="inp" value="<?php echo $this->_tpl_vars['info']['desc']; ?>
" id="describe" placeholder="请在这里输入封面描述">
							</div>
                            ...
                            <input type="file" name="file" class="layui-upload-file" id="myfile" style="display:none">
								...
								<div class="layui-upload-list" id="piclist">
									<?php if ($this->_tpl_vars['info']['thumbfile'] != ''): ?>
									<div class="upic"><img src="<?php echo $this->_tpl_vars['info']['thumbfile']; ?>
