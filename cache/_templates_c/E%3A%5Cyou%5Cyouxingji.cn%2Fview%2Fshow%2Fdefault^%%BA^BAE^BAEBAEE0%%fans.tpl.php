<?php /* vpcvcms compiled created on 2018-09-12 16:07:35
         compiled from user/fans.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'helper', 'user/fans.tpl', 59, false),)), $this); ?>
<!DOCTYPE html>
<html lang="zh-CN">
                    ...
                    <div class="m-atten-lb">
                        <div class="tit">
                            <div class="so">
                                ...
                                <input type="text" class="inp" id="keys" value="<?php echo $this->_tpl_vars['keys']; ?>
" placeholder="查找朋友">
                            </div>
                            <h4>我的粉丝 <em><?php echo ((is_array($_tmp=$this->_tpl_vars['user']['uid'])) ? $this->_run_mod_handler('helper', true, $_tmp, 'fansnum') : smarty_modifier_helper($_tmp, 'fansnum')); ?>
</em></h4>
                        </div>
                    </div>
 ...
 ?>
    ...
    <script type="text/javascript">
        $('#pageqr').click(function(){
            var page = $('#pages').val();
            if(page){
                window.location.href="/index.php?m=index&c=user&v=fans&keys=<?php echo $this->_tpl_vars['key']; ?>
&page=" + page;
            }
        })
        ...
        $('#btnSo').click(function(){
            ...
            window.location.href="/index.php?m=index&c=user&v=fans&keys=" + keys;
        })
