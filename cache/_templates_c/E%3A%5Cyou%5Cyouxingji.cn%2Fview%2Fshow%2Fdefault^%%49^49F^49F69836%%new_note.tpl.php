<?php /* vpcvcms compiled created on 2018-11-02 10:17:25
         compiled from wap/user/new_note.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'helper', 'wap/user/new_note.tpl', 52, false),)), $this); ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8" />
...
?>
								...
								<p class="right">
									...
									<?php if ($this->_tpl_vars['item']['status'] == 1): ?>
									<span class="review">
										<a href="/index.php?m=wap&c=index&v=rytdetai&id=<?php echo $this->_tpl_vars['item']['id']; ?>
">
