<?php /* vpcvcms compiled created on 2019-01-09 16:10:40
         compiled from user/faq/set_question.tpl */ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
    ...
    <title>发布问题_<?php echo $this->_reg_objects['TO'][0]->cfg(array('key' => 'site_name','group' => 'site','default' => "广州游行迹新媒体科技有限公司"), $this);?>
</title>
	    ...
	    <div class="wp">
	        <div class="m-master-qm">
	        	...
	        	<div class="col_l">
	                ...
	                <input class="inp" type="text" name="" value="<?php echo $this->_tpl_vars['res']['title']; ?>
" id="title" maxlength="80" onkeyup="judgeIsNonNull1(event)" placeholder="标题不少于10个字" />
	                <p class="tips tips1"><span class="" id="contentwordage1">0</span> / 80字</p>
	                
	                <p class="headline title2">详细内容补充：</p>
	                <textarea class="txta1" placeholder="请输入你的问题说明，不少于10个字哦" id="describe" maxlength="1000" onkeyup="judgeIsNonNull2(event)"><?php echo $this->_tpl_vars['res']['describe']; ?>
</textarea>
