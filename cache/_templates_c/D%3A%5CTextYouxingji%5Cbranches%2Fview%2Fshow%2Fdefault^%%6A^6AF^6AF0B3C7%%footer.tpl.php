...
<div class="footer">
	<div class="fd-top" style="background-size: 100% 100%;">
		<div class="wp">
			<div class="top">
				<div class="tel">
					<h3>客服热线</h3>
				...
				<div class="fd-nav">
					<dl><dt>关于游行迹</dt>
						<dd><a href="/index.php?m=index&c=aboutus&v=index">关于我们</a></dd>
...
?>
						<div class="swiper-slide"><a href="<?php echo $this->_tpl_vars['link']['link']; ?>
...
<div class="m-float-qm">
	...
	<a href="javascript:;" class="ma">
		...
		<div class="boximg"><img src="<?php echo $this->_reg_objects['TO'][0]->cfg(array('key' => 'site_weixin','group' => 'site ','default' => ' '), $this);?>
" alt=""></div>
	</a>
...
<script>
	...
	$(function(){
		...
		var swiper20 = new Swiper('.footerswiper', {
			slidesPerView: 5,
			spaceBetween: 1,
			speed: 3000,
			autoplay: {
