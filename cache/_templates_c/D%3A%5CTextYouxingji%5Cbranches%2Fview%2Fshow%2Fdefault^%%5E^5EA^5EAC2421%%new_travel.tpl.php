<?php /* vpcvcms compiled created on 2019-01-03 20:25:19
         compiled from wap/user/new_travel.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'helper', 'wap/user/new_travel.tpl', 63, false),)), $this); ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8" />
...
" />
	    ...
	    <div class="row-TV minHeight">
	        <div class="m-nv-yz">
	            <div class="wp fix">
	                <ul class="fix">
	                	<li class="on"><a href="/index.php?m=wap&c=user&v=travel">日志&nbsp;<i class="Iclass" id="travel_num"><?php echo $this->_tpl_vars['total']['travel_num']; ?>
</i></a></li>
...
">
							...
							<p class="videoDetails Areview omit lineNumber3"><?php echo $this->_tpl_vars['item']['describes']; ?>
</p>
							<?php endif; ?>
