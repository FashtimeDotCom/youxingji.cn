<?php /* vpcvcms compiled created on 2018-10-19 16:33:10
...
"/>
					<div class="img_name"><?php echo $this->_tpl_vars['item']['name']; ?>
</div>
				</a>
			</div>
			<div class="d-nav">
...
<?php endif; ?>">
					<div class="nav-img-box"><img src="/resource/images/swim/mobile/y_06.png"/></div>
					<div>我要报名</div>
				</div>
				<div data-url = "<?php if ($this->_tpl_vars['item']['id'] == 1): ?>/index.php?m=wap&c=swim&v=roster_list&activity_id=4<?php else: ?><?php if ($this->_tpl_vars['item']['living']): ?>/index.php?m=wap&c=swim&v=roster_list&activity_id=<?php echo $this->_tpl_vars['item']['living']['activity_id']; ?>
<?php else: ?>javascript:void(0)<?php endif; ?><?php endif; ?>">
					<div class="nav-img-box"><img src="/resource/images/swim/mobile/y_08.png"/></div>
					<div>名单公布</div>
				</div>
...
<?php else: ?>javascript:void(0)<?php endif; ?>">
					<div class="nav-img-box"><img src="/resource/images/swim/mobile/y_10.png"/></div>
					<div>行程直播</div>
				</div>
			</div>
			<div class="title-nav">
