...
" id="title" placeholder="请在这里输入游记的标题">
						...
						<div class="tit" style="margin-bottom: 20px;">
							<textarea class="layui-textarea inp txta1" id="describe" placeholder="请在这里输入游记的摘要/封面描述" style="line-height: 22px;"><?php echo $this->_tpl_vars['res']['desc']; ?>
</textarea>
						...
						<div class="pic-video tit">
							<div class="myfile fix">
								<div class="layui-upload-list fix" id="piclist" style="height: 100%;">
									<?php if ($this->_tpl_vars['res']['thumbfile'] != ''): ?>
									<img class="note_bg layui-upload-img" data-default="" src="<?php echo $this->_tpl_vars['res']['thumbfile']; ?>
">
									<?php else: ?>
