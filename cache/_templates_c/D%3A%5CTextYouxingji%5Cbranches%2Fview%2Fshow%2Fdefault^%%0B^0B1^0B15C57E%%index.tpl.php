<?php /* vpcvcms compiled created on 2018-12-27 17:01:30
...
<head>
	...
	<title>TA的日志_<?php echo $this->_reg_objects['TO'][0]->cfg(array('key' => 'site_name','group' => 'site','default' => "广州游行迹新媒体科技有限公司"), $this);?>
</title>
...
">
									<div class="con fix">
										<div class="left">
											<a class="dis_block figure borderRadius50 headPortrait" style="background-image: url(<?php echo $this->_tpl_vars['muser']['avatar']; ?>
);"></a>
...
</p><span class="date"><?php echo $this->_tpl_vars['vo']['addtime']; ?>
</span>
											</div>
