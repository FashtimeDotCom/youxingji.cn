<?php /* vpcvcms compiled created on 2019-01-02 17:26:54
...
">
							<div class="pic figure" style="background-image: url(http://www.youxingji.cn/<?php echo $this->_tpl_vars['item']['avatar']; ?>
								...
								<div class="txt"><?php echo $this->_tpl_vars['item']['tag']; ?>
</div>
							</div>
							<span class="username"><?php echo $this->_tpl_vars['item']['username']; ?>
</span>&nbsp;|&nbsp;
