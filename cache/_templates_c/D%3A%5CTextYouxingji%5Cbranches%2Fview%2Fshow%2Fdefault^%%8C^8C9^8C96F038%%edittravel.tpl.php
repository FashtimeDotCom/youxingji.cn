<?php /* vpcvcms compiled created on 2019-01-03 22:38:12
...
" id="title" placeholder="请在这里输入标题">
						...
						<div class="content-txt" style="overflow: auto;margin-bottom: 0px;">
							<textarea placeholder="请在此处编辑正文内容" class="txta1" id="describe" onkeyup="judgeIsNonNull1(event)"><?php echo $this->_tpl_vars['res']['describes']; ?>
</textarea>
...
" id="code">
							...
							<input type="hidden" name="Add" value="<?php echo $this->_tpl_vars['res']['address']; ?>
" id="address" title="后台返回来的定位地址">
							<p id="Paddress" class="address"><?php echo $this->_tpl_vars['res']['address']; ?>
</p>
						</div>
						<ul id="previewImage">
							<?php if ($this->_tpl_vars['res']['content']): ?>
...
' /><i class="delete iz layui-icon">&#xe640;</i></div></li>
						...
						<!--草稿箱的数据，如果有图片，就储存到这里-->
						<input type="hidden" name="" id="imgList" value="<?php echo $this->_tpl_vars['res']['str_content']; ?>
" />
						<input type="hidden" name="did" value="<?php echo $this->_tpl_vars['res']['id']; ?>
" id="did" title="编辑ID">
					</form>
				</div>
			</div>
