<?php /* vpcvcms compiled created on 2018-07-12 09:55:45
...
" /></span>
            ...
            <div class="lock" title="锁定"><i class="icon-key"></i></div>
        </div>
    </div>
    <div id="sidebar">
        <div class="search" style="color: white;"></div>
        <!--menu-->
...
?>
            <li class="sub-menu open" index="<?php echo ($this->_foreach['topmenu']['iteration']-1); ?>
" data-search="<?php echo $this->_tpl_vars['key']; ?>
">
                <a href="javascript:void(0);" class="pitem" onclick="change_menu(<?php echo ($this->_foreach['topmenu']['iteration']-1); ?>
)">
...
<?php else: ?>icon-circle-blank<?php endif; ?>"></i>
                    ...
                    <i class="icon-angle icon-angle-right"></i>
                </a>
...
" class="item">
    ...
    <script>
        ...
        {
            $(".sidebar-menu li.open ul").hide(700);
        }
    </script>
