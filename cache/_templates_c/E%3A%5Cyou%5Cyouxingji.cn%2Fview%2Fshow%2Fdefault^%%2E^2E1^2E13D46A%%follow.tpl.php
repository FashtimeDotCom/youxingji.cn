<?php /* vpcvcms compiled created on 2018-09-03 17:04:02
         compiled from wap/user/follow.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'helper', 'wap/user/follow.tpl', 86, false),)), $this); ?>
<!DOCTYPE html>
<html lang="zh-CN">
 ...
 ?> 
    ...
    <script type="text/javascript">
        ...
        $('#btnSo').click(function(){
            ...
            window.location.href="/index.php?m=wap&c=user&v=follow&keys=" + keys;
        })
      	function smg(uid){
