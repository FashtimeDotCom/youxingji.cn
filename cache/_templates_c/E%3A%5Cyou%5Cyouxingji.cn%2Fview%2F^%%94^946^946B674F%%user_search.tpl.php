...
')"><?php echo $this->_tpl_vars['user']['username']; ?>
                ...
                <td class="tdl">
                    <input type="checkbox" name="trainee[<?php echo $this->_tpl_vars['user']['uid']; ?>
]" value="1"<?php if ($this->_tpl_vars['user']['trainee']): ?> checked<?php endif; ?> />
                </td>
              	<td class="tdl">
                    <input type="checkbox" name="weektop[<?php echo $this->_tpl_vars['user']['uid']; ?>
]" value="1"<?php if ($this->_tpl_vars['user']['weektop']): ?> checked<?php endif; ?> />
                </td>
                <td class="tdl">
                    <input type="checkbox" name="startop[<?php echo $this->_tpl_vars['user']['uid']; ?>
]" value="1"<?php if ($this->_tpl_vars['user']['startop']): ?> checked<?php endif; ?> />
                </td>
                <td class="tdl">
...
')">编辑</a>
                  		<a href="/admin/user/login/uid/<?php echo $this->_tpl_vars['user']['uid']; ?>
" target="_blank">登陆</a>
