<?php /* vpcvcms compiled created on 2018-09-03 17:04:36
         compiled from wap/user/findfriends.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'helper', 'wap/user/findfriends.tpl', 86, false),)), $this); ?>
<!DOCTYPE html>
<html lang="zh-CN">
 ...
 ?> 
    ...
    <script type="text/javascript">
        ...
        $('#btnSo').click(function(){
            ...
            window.location.href="/index.php?m=wap&c=user&v=findfriends&keys=" + keys;
        })
      	function smg(uid){
