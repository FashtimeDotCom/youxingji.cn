<?php /* vpcvcms compiled created on 2018-11-01 19:02:26
         compiled from wap/tv_detail.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'wap/tv_detail.tpl', 100, false),array('modifier', 'helper', 'wap/tv_detail.tpl', 129, false),)), $this); ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8" />
...
"></iframe>
        	<div class="main fix">
            	...
            	<div class="boxTop fix">
            		<p class="title"><?php echo $this->_tpl_vars['info']['title']; ?>
</p>
	            	<p class="describe"><?php echo $this->_tpl_vars['info']['describes']; ?>
</p>
	            	<div class="boxs fix">
...
?>
							<div class='swiper-slide'>
								<div class='pic figure' onclick="js_video(this)" data-src="<?php echo $this->_tpl_vars['item']['url']; ?>
" style="background-image: url(<?php echo $this->_tpl_vars['item']['pics']; ?>
								...
								<p class="little_title"><a class="dis_block omit lineNumber2" href="/index.php?m=wap&c=index&v=tv_detail&id=<?php echo $this->_tpl_vars['item']['id']; ?>
