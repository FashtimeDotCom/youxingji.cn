<?php /* vpcvcms compiled created on 2018-11-02 16:11:16
         compiled from wap/faq/response_detail.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'helper', 'wap/faq/response_detail.tpl', 105, false),array('modifier', 'date_format', 'wap/faq/response_detail.tpl', 194, false),)), $this); ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8" />
...
,this)"><?php echo ((is_array($_tmp=$this->_tpl_vars['info']['uid'])) ? $this->_run_mod_handler('helper', true, $_tmp, 'isfollows') : smarty_modifier_helper($_tmp, 'isfollows')); ?>
					...
					<div class="substanc fix"><div class="solution description"><?php echo $this->_tpl_vars['info']['content']; ?>
</div></div>
					...
					<div class="videoBottom fix">
						<div class="left">
							<span class="zan" onclick="zan(this,<?php echo $this->_tpl_vars['info']['id']; ?>
								...
								<img class="icon_like" src="http://localhost.youxingji.cn/resource/m/images/common/icon_like.png"><i class="Iclass"><?php echo $this->_tpl_vars['info']['top_num']; ?>
</i>
							</span>&nbsp;&nbsp;
						</div>
